        ...
        <div class="mt-4 flex flex-wrap gap-2">
            <a
                ...
                @class([
                    ...
                    'border border-slate-300 bg-white text-slate-700 hover:border-indigo-500 hover:text-indigo-700' => $selectedCategoria !== '',
                ])
            ...
            @foreach ($categorias as $categoria)
                <a
                    href="{{ route('articulos.index', ['categoria' => $categoria->slug]) }}"
                    @class([
                        'rounded-full px-4 py-2 text-sm font-semibold transition',
                        'bg-indigo-600 text-white' => $selectedCategoria === $categoria->slug,
                        'border border-slate-300 bg-white text-slate-700 hover:border-indigo-500 hover:text-indigo-700' => $selectedCategoria !== $categoria->slug,
                    ])
            ...
            @foreach ($articulos as $articulo)
                ...
                >
                    ...
                    >
                        ...
                        @else
                            <div
                                class="flex aspect-video w-full items-center justify-center bg-gradient-to-br from-slate-100 to-indigo-100"
                                role="img"
